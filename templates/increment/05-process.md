...
- Within the given path:
  ...
  - Skim any relevant documents in this scope, such as previous increments, improve documents, or ADRs.
...
- Only after the user gives a clear affirmative at STOP 2 (for example: "yes", "go ahead", "looks good"):
  - Generate the full increment definition that:
    - Follows the structure described in the Output Structure section.
